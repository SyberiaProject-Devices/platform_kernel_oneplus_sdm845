...
static void write_default_values(struct cgroup_subsys_state *css)
{
	u8 i;
	char cg_name[11];
	const int boost_values[3] = { 0, 0, 0 };
	const bool prefer_idle_values[3] = { 1, 1, 0 };
	const bool sched_colocate_values[3] = { 0, 0, 0 };
	const bool sched_boost_no_override_values[3] = { 1, 1, 0 };
